export const RARITIES = [
  ...
  { name: 'Super',     color: '#29F79E', petalMult: 192, statMult: 30000,  dmgMult: 192, armorMult: 192, weight: 0, scale: 8.0, maxShare: 0.001, manualOnly: true },
...
export const MOB_TYPES = {
  ...
  scorpion: {
    name: 'Scorpion', hp: 80, dmg: 40, armor: 3, radius: 2.0, speed: 5, xp: 15,
    drops: [['iris', 1], ['pincer', 1]],
    sightAggro: 18,
    spawnWeight: 0.44,
    spawnBiome: 'desert',
  },
...
export const PETAL_TYPES = {
  ...
  missile:   { name: 'Missile', hp: 2,  dmg: 20, reload: 3,   radius: 0.4,  count: 1, color: '#333333',
               ...
               desc: 'pew pew' },
  glass:     { name: 'Glass',   hp: 3,  dmg: 7, reload: 1.5, radius: 0.4,  count: 1, color: '#eaf6fb',
               hitCooldown: 1,
...
export const PLAYER_MODEL_IDS = [
  ...
  'shinyladybug', 'goldenleafbug', 'leafbug', 'bush',
];
