...
import {
  PETAL_TYPES, RARITIES, PLAYER_MODEL_IDS, TILE_TYPES, SPAWN_IMMUNITY, SPAWN_POS, FLIGHT, MOB_TYPES,
...
export class Player {
  ...
  refreshLoadoutSlots() {
    ...
    // Common/Unusual: 5 slots, Rare: 6 ... Ultra: 10, Super: 11.
    this.petals.setSlotCount(Math.max(5, highest + 4));
  }
