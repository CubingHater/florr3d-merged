    ...
    const next = mats.map((m) => {
      ...
      if (!toon) {
        toon = new THREE.MeshToonMaterial({
          ...
          side: m.side,
          // Skinning and morph-target support are inferred from the mesh
          // geometry by current Three.js versions. Passing the old material
          // flags through produces one console warning per imported model.
