...
const MODELS = {
  ...
  beetle:  { url: new URL('../assets/beetle.glb', import.meta.url), yaw: YAW, flip: Math.PI, turn: Math.PI / 2 },
  ...
  jungleladybug:  { url: new URL('../assets/jungleladybug.glb', import.meta.url), yaw: YAW, flip: Math.PI },
