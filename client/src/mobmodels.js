...
const MODELS = {
  ...
  nazarbeetle: { url: new URL('../assets/nazarbeetle.glb', import.meta.url), yaw: YAW, flip: Math.PI, turn: Math.PI },
  ...
  shinyladybug: { url: new URL('../assets/shinyladybug.glb', import.meta.url), yaw: YAW, flip: Math.PI, turn: 50 * Math.PI / 180 },
  ...
  spider: { url: new URL('../assets/spiderfull.glb', import.meta.url), yaw: 0 },//{ url: new URL('../assets/spiderbody.glb', import.meta.url), yaw: YAW },
  spiderlegs: { url: new URL('../assets/spiderleg.glb', import.meta.url), yaw: YAW },
  centi: { url: new URL('../assets/centihead.glb', import.meta.url), yaw: YAW },
};
